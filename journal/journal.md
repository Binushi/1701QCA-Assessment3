...
If I was to Further develop this project I would find a way to make the sound sensor more sensitive. As the sound sensor needs a lot of volume to pick up anything for the light to turn on. I would also like to change the patterns of lights turn on maybe with different sounds that could be different patterns. I I would also experiment with more LEDs and different types of senses. For example I could have two different sets of lights with two different senses on the same jacket￼i￼. I would have also like to make my video a bit smoother there’s some parts where it  jump cuts. I also had a lot of other editing techniques I wanted to try but did not have enough time to do.￼
